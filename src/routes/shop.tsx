          ...
          {[...products, ...products].map((p, i) => (
            <article key={i} className="relative flex flex-col justify-between">
              <div>
                ...
                <div className="overflow-hidden rounded-xl bg-blush aspect-square border border-blush-strong/10">
                ...
                <Link to="/shop" className="block text-primary font-bold text-sm leading-tight line-clamp-2 mt-1">{p.name}</Link>
